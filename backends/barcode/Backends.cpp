	...
	namespace barcode
	{
		...
		Backends::Backends()
		{
			...
			registerStyle( "cbr", "zint", tr("Codabar"),
			               true, true, true, true, "A00000000B", false, 10 );
			...
			registerStyle( "daft", "zint", tr("DAFT Code"),
			               false, false, false, false, "DAFTDAFTDAFTDAFT", false, 16 );
			...
			registerStyle( "rm4sm", "zint", tr("Royal Mail 4-State Mailmark"),
			               false, false, true, false, "01000000000000000AA00AA0A", false, 25 );

			#if LIBZINT_VERSION >= 21200
			registerStyle( "rm2dm", "zint", tr("Royal Mail 2-D Mailmark"),
			               false, false, true, false, "012100123412345678AB19XY1A 0", false, 28 );
			#endif
