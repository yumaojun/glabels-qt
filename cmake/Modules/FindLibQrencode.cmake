...
set(_LIBQRENCODE_x86 "(x86)")
set(_LIBQRENCODE_INCLUDE_SEARCH_NORMAL
  "$ENV{ProgramFiles}/QRencode"
  "$ENV{ProgramFiles${_LIBQRENCODE_x86}}/QRencode")
set(_LIBQRENCODE_LIB_SEARCH_NORMAL
  "$ENV{ProgramFiles}/QRencode/lib"
  "$ENV{ProgramFiles${_LIBQRENCODE_x86}}/QRencode/lib")
unset(_LIBQRENCODE_x86)
...
find_path(LIBQRENCODE_INCLUDE_DIR NAMES qrencode.h
   ...
   PATHS
   ${_LIBQRENCODE_INCLUDE_SEARCH_NORMAL}
...
find_library(LIBQRENCODE_LIBRARY NAMES qrencode libqrencode
   ...
   PATHS
   ${_LIBQRENCODE_LIB_SEARCH_NORMAL}
   )
   
set (LIBQRENCODE_INCLUDE_DIR "C:/Program Files (x86)/QRencode/include/")
set (LIBQRENCODE_LIBRARY "C:/Program Files (x86)/QRencode/lib/qrencode.lib")
set (PC_LIBQRENCODE_VERSION "4.1.1")
